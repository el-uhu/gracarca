...
export default class LayerCake extends SvelteComponentTyped<{
    ...
    xDomain?: Function | string[] | number[] | [min: number, max: number];
    yDomain?: Function | string[] | number[] | [min: number, max: number];
    zDomain?: Function | string[] | number[] | [min: number, max: number];
    rDomain?: Function | string[] | number[] | [min: number, max: number];
...
declare const __propDef: {
    props: {
        ...
        xDomain?: [min: number | null, max: number | null] | string[] | number[] | Function;
        yDomain?: [min: number | null, max: number | null] | string[] | number[] | Function;
        zDomain?: [min: number | null, max: number | null] | string[] | number[] | Function;
        rDomain?: [min: number | null, max: number | null] | string[] | number[] | Function;
